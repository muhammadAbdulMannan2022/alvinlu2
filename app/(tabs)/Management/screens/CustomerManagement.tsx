          ...
          <View className="px-5 py-4">
            ...
            <View className="flex-row items-center justify-between mb-4">
              ...
              <TouchableOpacity
                ...
                className="flex-row items-center bg-white border border-gray-300 rounded-lg px-3 py-1.5"
              >
            ...
            {filterMenuVisible && (
              <View className="bg-white border border-gray-200 rounded-lg shadow-lg mb-4 overflow-hidden">
                ...
                >
                  <Text className="text-sm text-gray-900">All customer</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() => {
                    setSelectedFilter("Current Booking");
                    setFilterMenuVisible(false);
                  }}
                  className="px-4 py-3"
                >
                  <Text className="text-sm text-gray-900">Current Booking</Text>
                </TouchableOpacity>
              </View>
            )}
                    ...
                    <View className="flex-row items-center mb-1">
                      ...
                      {customer.badge && (
                        <View
                          ...
                          style={{ backgroundColor: customer.badgeColor }}
                        >
          ...
          >
            ...
            >
              ...
              >
                ...
                <TouchableOpacity
                  onPress={() => handleMenuAction("Add badge")}
